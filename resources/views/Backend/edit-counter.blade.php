    ...
    <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                <li class="nav-item">
                    <a class="nav-link active" id="pills-addskill-tab" data-toggle="pill" href="#pills-editskill" role="tab" aria-controls="pills-editskill"><i class="fas fa-plus"></i> Edit Counter</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade show active" id="pills-editskill" role="tabpanel" aria-labelledby="pills-editskill-tab">
                    <form action="{{ route('update.counter', ['id'=> $counter->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ $counter->title }}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="home-page-label">Add Number For This Counter</label>
                            <input type="text" name="number" value="{{ $counter->number }}" class="form-control">
                        </div>
