      ...
      <div className="Game">
        <div className="poker-table--wrapper">
          <div className="screenSize">
            <img src="./assets/monitor.svg" alt="Screen size" />
            <p>{screenSize}</p>
          </div>
          {
            this.state.loading ? (
        ...
        <Chat socket={this.props.socket} username={this.props.username} room={this.props.room} />
      </div>
    );
  }
}
